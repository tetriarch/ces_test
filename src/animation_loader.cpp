...
auto AnimationLoader::load(AssetManager &assetManager,
                           const std::string &filePath) -> IAssetPtr {
...
auto AnimationLoader::parseAnimationData(const json &o,
...
auto AnimationLoader::error(const std::string &msg, const std::string &parent)
    -> std::string {
