...
auto AnimationLoader::parseAnimation(const std::string& source) -> std::expected<AnimationData, JSONParserError> {
...
auto AnimationLoader::parseAnimationData(const json& o, const std::string& parent) -> std::expected<AnimationData, JSONParserError> {
